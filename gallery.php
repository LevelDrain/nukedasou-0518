...
<main class="l-main">
    <section class="p-archive" id="archive">
        <div class="l-container">
            ...
            <h3 class="p-gallery c-title">たぬき会</h3>
            ...
            <div class="p-gallery--container">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        foreach ($record as $id => $contents):
                            ...
                            <div class="swiper-slide slide-item">
                                <a href="images/banner/<?= h($contents[2]) ?>" data-lightbox="tanuki"><img
                                            src="images/banner/<?= h($contents[2]) ?>" alt=""></a>
                            </div>
                        <?php endif; ?>
                ...
                <h3 class="p-gallery c-title">ぬけだ荘ラジオ</h3>
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <!-- ここからswiperテンプレ -->
                        <?php
                        foreach ($record as $id => $contents):
                            ...
                            <div class="swiper-slide slide-item">
                                <a href="images/banner/<?= h($contents[2]) ?>" data-lightbox="radio"><img
                                            src="images/banner/<?= h($contents[2]) ?>" alt=""></a>
                            </div>
                        <?php endif; ?>
                ...
                <h3 class="p-gallery c-title">泥酔会</h3>
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <!-- ここからswiperテンプレ -->
                        <?php
                        foreach ($record as $id => $contents):
                            ...
                            <div class="swiper-slide slide-item">
                                <a href="images/banner/<?= h($contents[2]) ?>" data-lightbox="drink"><img
                                            src="images/banner/<?= h($contents[2]) ?>" alt=""></a>
                            </div>
                        <?php endif; ?>
                ...
                <h3 class="p-gallery c-title">ぬけだ荘の歩き方</h3>
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <!-- ここからswiperテンプレ -->
                        <?php
                        foreach ($record as $id => $contents):
                            ...
                            <div class="swiper-slide slide-item">
                                <a href="images/banner/<?= h($contents[2]) ?>" data-lightbox="walk"><img
                                            src="images/banner/<?= h($contents[2]) ?>" alt=""></a>
                            </div>
                        <?php endif; ?>
                ...
                <h3 class="p-gallery c-title">その他</h3>
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <!-- ここからswiperテンプレ -->
                        <?php
                        foreach ($record as $id => $contents):
                            ?>
                            <?php if ($contents[1] == 'others'): // その他 ?>
                            <div class="swiper-slide slide-item">
                                <a href="images/banner/<?= h($contents[2]) ?>" data-lightbox="others"><img
                                            src="images/banner/<?= h($contents[2]) ?>" alt=""></a>
                            </div>
                        <?php endif; ?>
